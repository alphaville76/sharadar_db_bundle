...
from sharadar.live.brokers.ibpy_broker import TWSConnection, IBBroker
...
class TestIBBroker(WithSimParams,
    ...
    @staticmethod
    def _tws_bars():
        with patch('sharadar.live.brokers.ibpy_broker.TWSConnection.connect'):
    ...
    @patch('sharadar.live.brokers.ibpy_broker.TWSConnection')
    ...
    def test_get_realtime_bars_produces_correct_df(self):
        ...
        with patch('sharadar.live.brokers.ibpy_broker.TWSConnection'):
            broker = IBBroker(sentinel.tws_uri)
    ...
    @patch('sharadar.live.brokers.ibpy_broker.symbol_lookup')
